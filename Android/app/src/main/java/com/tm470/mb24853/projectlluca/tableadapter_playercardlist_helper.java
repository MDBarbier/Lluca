 ...
 */
    ...
    public class tableadapter_playercardlist_helper extends CursorAdapter {

    Context context;
    LLuca_Local_DB_Helper db_helper = new LLuca_Local_DB_Helper(context, null, null, 1);

        //Constructor
        public tableadapter_playercardlist_helper(Context context, Cursor c, boolean autoRequery) {
        ...
        public View newView(Context context, Cursor cursor, ViewGroup parent) {
            ...
            return LayoutInflater.from(context).inflate(R.layout.listviewtemplate_playercardlist,parent, false);
        }
