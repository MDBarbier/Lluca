 ...
 */
public class tableadapter_encountercard_helper extends CursorAdapter {
    ...
    //Constructor
    public tableadapter_encountercard_helper(Context context, Cursor c, boolean autoRequery) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        return LayoutInflater.from(context).inflate(R.layout.listviewtemplate_encountercardlist,parent, false);
    }
